...
- Shell: add 3 different instanciation methods, 
- Shell constructors: make_extrusion, make_wedge, make_revolve
- Solid constructors: make_extrusion, make_extrusion_from_frame_and_wires, make_wedge, make_revolve
